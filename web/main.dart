...
main() {
    ...
    model.fields.add(new DataSourceSchemaModelField(field: "conclusionDate", type: "date"));
    ...
    var transport = new DataSourceTransport()
      ..read = transportRead;
    ...
    options.columns.add(new GridColumn(field: "number", title: "№", width: 150, filterable : true)  );
